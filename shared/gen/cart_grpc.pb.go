...
type CartServiceClient interface {
	...
	// 清空购物车（结算完成后调用）
	ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*common.Empty, error)
}
...
func (c *cartServiceClient) ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*common.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CartServiceServer interface {
	...
	// 清空购物车（结算完成后调用）
	ClearCart(context.Context, *ClearCartRequest) (*common.Empty, error)
...
func (UnimplementedCartServiceServer) ClearCart(context.Context, *ClearCartRequest) (*common.Empty, error) {
