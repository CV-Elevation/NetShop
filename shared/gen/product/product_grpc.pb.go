...
type ProductServiceClient interface {
	// 按 ID 查询单个商品
	GetProduct(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*common.Product, error)
	// 查询商品列表（支持分类过滤）
	ListProducts(ctx context.Context, in *ListProductsRequest, opts ...grpc.CallOption) (*ListProductsResponse, error)
	// AI 搜索：自然语言关键词 + 条件过滤（供 aiassistant 调用）
...
func (c *productServiceClient) GetProduct(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*common.Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Product)
...
type ProductServiceServer interface {
	// 按 ID 查询单个商品
	GetProduct(context.Context, *GetProductRequest) (*common.Product, error)
	// 查询商品列表（支持分类过滤）
...
func (UnimplementedProductServiceServer) GetProduct(context.Context, *GetProductRequest) (*common.Product, error) {
