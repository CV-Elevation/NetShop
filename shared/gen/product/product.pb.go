...
type SearchProductsRequest struct {
	...
	Category      string                 `protobuf:"bytes,4,opt,name=category,proto3" json:"category,omitempty"` // 空表示不限
...
const file_product_proto_rawDesc = "" +
	...
	"\tmax_price\x18\x02 \x01(\x03R\bmaxPrice\x12\x1b\n" +
	"\tmin_price\x18\x03 \x01(\x03R\bminPrice\x12\x1a\n" +
